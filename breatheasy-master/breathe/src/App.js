  ...
  render() {
    return (
      <div className="app">
          ...
          <div className="text">
            <p className="intro">Often anxiety is caused by subconsciously hyperventilating. We are going to teach you how to breathe.</p>
            <p className="intro">Click on the start button below to begin your journey</p>
              <ol>
